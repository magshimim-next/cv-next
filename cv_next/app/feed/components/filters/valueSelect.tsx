...
export const DropdownInput = ({
  ...
  return (
    <>
      <div
        className={`outline-gray-40 relative flex h-2/6 items-center justify-center whitespace-nowrap bg-white outline-2 ${menuBorderStyle} box-border cursor-pointer rounded-md px-2 py-4 min-w-0`}
